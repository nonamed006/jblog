...
public class BlogApiController {
	...
	public String addcategory(@RequestBody CategoryVo vo, @PathVariable("id") String id) {// json으로 오니까 그걸 class로 바꿔서 
	...
	@GetMapping("delcat/{no}")
	public String delcategory(@PathVariable("no") int no) {
		System.out.println(no);
		
		boolean result = categoryService.delcat(no);
